...
public enum Questao {
	...
	public String toString() {
		switch (this) {
			...
			case _1:
				return "1. Qual a sintaxe do Java para representar literais numéricos inteiros de base 8?\nIniciar o número com um zero, seguido pelos dígitos octais, que vão de 0 a 7.";
			...
			case _9:
				return "9. Qual o padrão adotado pelo Java (tipo literal) para representar números inteiros e de ponto flutuante? ";
				
			case _10:
				return "10. Qual o valor padrão utilizado pelo Java para inicializar um objeto?";
