...
//	1.	Qual a sintaxe do Java para representar literais num�ricos inteiros de base 8?.
...
//			2.	Qual o resultado do c�digo abaixo? 
	
//			(X) Compila e executa com sucesso, apresentado a soma no console;
//			() Compila e falha na execu��o;
//			() Falha na compila��o;
...
//	3.	Qual o resultado do c�digo abaixo?
//
//	(X) Compila e executa com sucesso, apresentado a soma no console;
//	() Compila e falha na execu��o;
//	() Falha na compila��o;
...
//			System.out.println("Resposta da quest�o 4:");
//			System.out.println(Resposta.COMPILA_E_EXECUTA_COM_SUCESSO);
			System.out.println(Resposta.FALHA_NA_COMPILACAO);
	}
	
//			5.	Qual o resultado do c�digo abaixo?
//
//			(X) Compila e executa com sucesso, apresentado a soma no console;
//			() Compila e falha na execu��o;
//			() Falha na compila��o;
...
//			6.	Qual o resultado do c�digo abaixo?
//
//			(x) Compila e executa com sucesso, apresentado a soma no console;
//			() Compila e falha na execu��o;
//			() Falha na compila��o;
...
//			Atribui��o direta com caractere literal, Atribui��o usando valor decimal, Atribui��o usando valor hexadecimal, Atribui��o usando valor octal, Atribui��o usando Unicode.
...
//			9.	Qual o padr�o adotado pelo Java (tipo literal) para representar n�meros inteiros e de ponto flutuante? 
//			Int e double.
	private static void questao9() {
		System.out.println(Questao._9);
		System.out.println("O pr�prio n�mero(que � interpretado como Int) e o n�mero com ponto(que � interpretado por padr�o como double).");
	}

//			10.	Qual o valor padr�o utilizado pelo Java para inicializar um objeto?
